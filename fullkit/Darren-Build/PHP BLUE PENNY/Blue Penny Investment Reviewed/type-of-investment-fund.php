...
<body>
    ...
    <div class="section first article">
        <div class="section__content">
            <h2 class="section__title">Type of Investment Fund</h2>
            <h4>Blue Penny Property Development Fund (BPPDF) Structure:</h4>
            <p>BPPDF will operate as a mutual fund and therefore the Protected Cell Company (PCC) shall be set up under Companies Act 1972.</p>
            <h4>Protected Cell Company (PCC):</h4>
            <p> Assets are segregated into different cells within that company under a PCC structure. Each cell is protected from any extension of liabilities from one cell to the other. The structure consists of <strong>one board </strong>who will oversee the entire structure and an <strong>advisory committee </strong>to each cell. It is also a cost efficient structure with <strong>one administrator</strong>, <strong>one audit firm </strong>and <strong>one company secretary. </strong>Each cell will be responsible for specific projects related to property development as demonstrated by the diagram below:</p>
        </div>
    </div>
    <div class="treeDiag">
        <div class="wrapper">
            <ul>
                <li class="noline">
                    <label for="item1">Foreign Investor</label>
                    <input id="item1" type="checkbox">
                    <ul>
                        <li>
                            <label for="item1">Seychelles PCC/Fund Core Cell</label>
                            <input id="item1" type="checkbox">
                            <ul><span class="more">&mldr;</span>
                                <li>
                                    <label for="item1.1">Cell A</label>
                                    <input id="item1.1" type="checkbox">
                                    <ul><span class="more">&mldr;</span>
                                        <li>
                                            <label class="noborder" for="item1.1.1">
                                                <div class="treeBox">
                                                    <h3>Investment in Residential Development in Mauritius</h3></div>
                                            </label>
                                            <input id="item1.1.1" type="checkbox">
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <label for="item1.2">Cell B</label>
                                    <input id="item1.2" type="checkbox">
                                    <ul><span class="more">&mldr;</span>
                                        <li>
                                            <label class="noborder" for="item1.2.1">
                                                <div class="treeBox">
                                                    <h3>Investment in Hotels Development in Mauritius</h3></div>
                                            </label>
                                            <input id="item1.2.1" type="checkbox">
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <label for="item1.3">Cell C</label>
                                    <input id="item1.3" type="checkbox">
                                    <ul><span class="more">&mldr;</span>
                                        <li>
                                            <label class="noborder" for="item1.3.1">
                                                <div class="treeBox">
                                                    <h3>Acquisition of  Land in Mauritius</h3></div>
                                            </label>
                                            <input id="item1.3.1" type="checkbox">
                                        </li>
                                    </ul>
                                </li>
                            </ul>
